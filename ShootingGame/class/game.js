...
export default class Game {
    ...
    createShot() {
        ...
        if (this._level < 5) {
            ...
            //x_arrayとv_arrayに1個分のX座標と速度をセット
        }
            ...
            v_array.push({ x: 0, y: 20 });
            v_array.push({ x: 0, y: 20 });
            //x_arrayとv_arrayに2個分のX座標と速度をセット
        }
            ...
            v_array.push({ x: 0, y: 20 });
            v_array.push({ x: 0, y: 20 });
            //x_arrayとv_arrayに3個分のX座標と速度をセット
        }
            ...
            v_array.push({ x: 2, y: 20 });
            v_array.push({ x: 4, y: 20 });
            //x_arrayとv_arrayに5個分のX座標と速度をセット
        }
        else {
            //LV50以上7way
            ...
            v_array.push({ x: 4, y: 20 });
            v_array.push({ x: 6, y: 20 });
            //x_arrayとv_arrayに7個分のX座標と速度をセット
        }
        //弾のY座標
